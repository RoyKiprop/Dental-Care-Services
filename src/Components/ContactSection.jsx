  ...
  return (
    <section className="bg-[#eeeeee] pt-16 pb-32 ">
      <div className="max-w-6xl mx-auto flex space-x-8  ">
        <div className="w-3/4">
          <h2 className="text-[#9dab9d] text-xl font-medium uppercase mb-4">
            Ihr Kontakt zu uns
          </h2>
          <p className="text-[#9dab9d] text-2xl font-medium mb-6 w-[85%]">
          ...
          <div className="flex items-center mb-8">
            ...
            <div className="ml-4 mt-5">
              <h4 className="text-2xl text-[#c19e78] mb-1">02642 9931-270</h4>
          ...
          <div className="flex  items-center">
            ...
            <div className="ml-4">
              <h4 className="text-2xl text-[#9dab9d] font-medium mb-1">
                02642 9931-274
              </h4>
          ...
          <div className="flex items-start my-8">
            ...
            <div className="ml-4">
              <h4 className="text-2xl text-[#c19e78] mb-1">
          ...
          <h3 className="text-[#9dab9d] text-xl font-medium uppercase mb-4">
            So finden Sie uns
          </h3>
          <p className="text-gray-800 w-[85%] mb-6">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-2">
              <h3 className="text-[#9dab9d] text-xl font-medium uppercase mb-1">
                Orthodontics Remagen Sinzig
              </h3>
              <p className="text-[#c19e78] text-lg font-medium">
        ...
        <div className="flex space-y-6 flex-col w-1/4">
          <div>
            <img src={ToothLogo} className="block w-full max-w-48" />
          </div>
          <h3 className="text-[#9dab9d] text-xl  uppercase mb-4">
            Öffnungszeiten
          </h3>
          <div className="mb-6 ">
            <p className="text-[#c19e78] text-xl  mb-4">
              Montag bis Donnerstag
            </p>
            <p className="text-[#9dab9d] text-lg font-medium">
              08:15 – 12:15 Uhr
            </p>
            <p className="text-[#9dab9d] text-lg font-medium">
              13:15 – 17:45 Uhr
            </p>
            <p className="text-[#c19e78] text-xl mt-3">Freitag</p>
            <p className="text-[#9dab9d] font-medium text-lg">
              nach Vereinbarung
            </p>
          </div>
